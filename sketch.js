...
function preload(){
  backgroundImage=loadImage("PROJECTIMAGE.jpg");
  objectsImage = loadImage ("bone image.png");
  bodyImage = loadImage ("DOG IMAGEE.png");
  obstacleImage = loadImage ("stickpng.png");
   gameOverImage = loadImage ("gamee overr.png");
